...
Usage:
    python3 scripts/2026-06-23-003-backfill-bio-en.py /path/to/x.db [--live]
"""
import subprocess
import sys
...
def main() -> int:
    if len(sys.argv) < 2:
        print(
            "usage: 2026-06-23-003-backfill-bio-en.py "
            "<db_path> [--live]",
            file=sys.stderr,
        )
        return 2
    ...
    base = [
        ...
        "accounts", "bio", "--locale", "en", "--limit", "500",
    ]
