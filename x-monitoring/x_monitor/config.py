...
VALID_QUERY_IDS: tuple[str, ...] = ("Q1", "Q2", "Q3", "Q4", "Q5")
...
class Config(BaseModel):
    ...
    # R17: skip order is Q5 first (lowest signal), then Q3, Q2, Q4, then Q1
    # last (highest signal-per-tweet — release announcements).
    degraded_skip_order: list[Literal["Q1", "Q2", "Q3", "Q4", "Q5"]] = Field(
        default_factory=lambda: ["Q5", "Q3", "Q2", "Q4", "Q1"]
    )
