"""R102: add-only secondary post-type coverage over the completed R101 primary.
...
PRIVATE = ROOT / ".context/u18/secondary-type-coverage-pilot-r102-v1"
...
CONTRACT = ROOT / "docs/analysis/2026-09-15-121500-u18-r102-secondary-type-coverage-contract.json"
REPORT = ROOT / "docs/analysis/2026-09-15-121500-u18-r102-secondary-type-coverage-results.json"
CANDIDATE = {
...
def prepare(path: Path):
    ...
    contract = {
        "schema_version": "u18-r102-secondary-type-coverage/v1", "status": "frozen_before_inference", "frozen_at": utc_now(),
        ...
        "evaluation": "Compare R101 primary and R102 merged output with the frozen owner reference. Report correct/incorrect additions, all-axis scores, per-type support/TP/FP/FN, cost, and gates. This experiment cannot activate production.",
    }
