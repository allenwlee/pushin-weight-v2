...
# Where the X conversation went next.

Threads carries the same short, unfiltered product talk as X — and far fewer brands are listening to it.

[Start free](https://herculeradar.com/login) [See pricing](https://herculeradar.com/#pricing)

LiveMentions · Acme

- @buildinpublic·Threads11m



Swapped our whole analytics stack this week. Took an afternoon, saved us about $400 a month.
...
Keyword search through a managed Actor, no login required. Each post keeps its author, likes, replies, reposts and view count.
...
- Public posts
- Author handle and profile
- Likes, replies, reposts and views
- Quote posts and replies

- The date filter is day-granular, so a scan may re-see a few posts it already stored. Deduplication absorbs them at no cost to your quota.
- Private accounts are never collected.

Pricing

## One price for every source.
...
Is Threads worth monitoring separately from X?Increasingly, yes. The audiences have diverged, and because far fewer companies watch Threads, a reply there tends to land with more weight.

Does it cost more than the other sources?No. Every source is included on every plan; only your total mention volume matters.
