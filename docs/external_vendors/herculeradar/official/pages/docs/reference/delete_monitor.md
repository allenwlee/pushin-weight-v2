...
Stops collection permanently. Mentions already collected are kept. Prefer update\_monitor with active:false if it may be wanted back.
...
```
curl "https://herculeradar.com/api/v1/monitors/:id" \
  --request DELETE \
...
```
{
  ...
  "meta": {
    ...
    "docs": "https://herculeradar.com/docs/reference/delete_monitor"
  }
}
```
