...
```
curl "https://herculeradar.com/api/v1/analytics/mentions" \
...
|     |     |     |
| --- | --- | --- |
| date\_preset | today \| last\_24\_hours \| last\_7\_days \| last\_30\_days \| last\_90\_days \| month\_to\_date \| all\_time | Named window (default last\_30\_days) |
...
```
{
  ...
  "meta": {
    ...
    "docs": "https://herculeradar.com/docs/reference/get_mention_analytics"
  }
}
```
