...
# People are praising you. You just have not seen it.

Positive mentions are the cheapest marketing asset you own, and almost all of them expire unread.
...
Switched to Acme last month. Setup took ten minutes and I have not thought about it since. Rare.
...
Asking customers for a testimonial is slow and awkward. Meanwhile someone posted an unprompted, specific, credible compliment last Tuesday and it scrolled away.

Plays

## What people actually do with it.

- Build a wall of proof from real posts

Filter to testimonials, open the original, ask for permission to quote. Two minutes per asset.

- Spot your quiet advocates

The same handles keep recommending you in threads. Those are the people to send early access to.

- Feed sales the exact wording

The phrase a happy user chose beats anything a copywriter guesses.
...
“Give me the ten best testimonials about Acme this quarter with links.”
...
Do I need permission to reuse a public post?We only ever show you public content and a link to it. Whether you can quote it in marketing depends on the platform’s terms and, in practice, on asking the author — which the link makes easy.

Can I export them?Every mention is available through the REST API and MCP, including its original URL.
