...
# Know what your name means to people who never contact you.

Most opinion about a brand is formed and expressed somewhere you were not invited. This is the part of it that is public.

[Start free](https://herculeradar.com/login) [Read the docs](https://herculeradar.com/docs)

LiveMentions · Acme

- @quietcritic·Threads14m



Acme used to be the simple option. Feels like it is turning into everything it replaced.
...
Brand tracking usually arrives as a quarterly survey: expensive, lagging, and answered by people who agreed to be surveyed. Meanwhile the same questions are answered for free every day, unprompted, by people who have no idea you are listening.

Plays

## What people actually do with it.

- Watch the misspellings too

Matching is literal, so the spaced form, the domain and the handle all belong in the monitor. Most mentions never link to you.

- Track sentiment against something

A sentiment number alone means nothing. Run a competitor monitor beside your own and the comparison becomes readable.

- Catch the drift early

Relevance rate tells you when your name has started colliding with something else — a film, a person, another company.
...
“How did sentiment about us move this month, and what drove it?”
...
[Get Solo](https://herculeradar.com/login?plan=starter&interval=monthly)
...
[Get Team](https://herculeradar.com/login?plan=pro&interval=monthly)
...
[Get Agency](https://herculeradar.com/login?plan=scale&interval=monthly)
...
Is this a replacement for brand tracking surveys?No, and anyone selling it as one is overreaching. A survey reaches a representative sample; this reaches people motivated enough to post. Both are biased, differently — read them together.

How far back can I see?A new monitor backfills roughly the last day and then keeps up. It builds history from the moment you start, so the useful comparison begins a month in.
