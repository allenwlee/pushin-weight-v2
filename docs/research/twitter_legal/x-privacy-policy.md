# X Privacy Policy — Verbatim Legal Reference

**Source URL:** https://x.com/en/privacy (redirects from https://x.com/privacy)
**Document type:** Privacy Policy (incorporated into the X User Agreement)
**Issued by:** X Corp. (US/non-EU) and X Internet Unlimited Company (EU/EFTA/UK)
**Effective: January 15, 2026**

**Retrieved:** 2026-07-17 by the minimax-marketing x-monitor legal-review pass.

**Companion documents in this folder:** `x-terms-of-service.md`, `x-developer-agreement.md`, `x-developer-policy.md`, `x-restricted-use-cases.md`, `x-display-requirements.md`, `x-geo-guidelines.md`, `x-developer-policies-index.md`, `x-tos-privacy-update-2026-blog.md`.
...
**Third-party content and integrations.** We share or disclose your information with your consent or at your direction, such as when you authorize a third-party web client or application to access your account or when you direct us to share your feedback with a business. Similarly, to improve your experience, we work with third-party partners to display their video content on X or to allow cross-platform sharing. When you watch or otherwise interact with content from our video or cross-platform sharing partners, they may receive and process your personal information as described in their privacy policies. For video content, you can adjust your autoplay settings if you prefer that content not to play automatically.
...
- explain why we have removed content or accounts from our services (e.g., for a violation of our Rules);
...
- To comply with a law, regulation, legal process, or governmental request. Including in order to adhere to a legally appropriate preservation request made by law enforcement. You can read more about law enforcement access [here](https://help.x.com/rules-and-policies/x-law-enforcement-support).
...
You can learn more about the information we have collected or inferred about you in Your X Data and request access to additional information [here](https://help.x.com/using-x/your-x-data).

You can download a copy of your information, such as your posts, by following the instructions [here](https://help.x.com/using-x/download-your-x-data).
