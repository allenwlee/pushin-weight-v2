# X Terms of Service — Verbatim Legal Reference

**Source URL:** https://x.com/en/tos (redirects from https://x.com/tos)
**Document type:** General user-facing Terms of Service (User Agreement component)
**Issued by:** X Corp. (US/non-EU) and X Internet Unlimited Company (EU/EFTA/UK)
**Two effective dates, by jurisdiction:**
- **Non-EU/EFTA/UK version (X Corp.): Effective April 10, 2026**
- EU/EFTA/UK version (X Internet Unlimited Company): Effective January 15, 2026

**Retrieved:** 2026-07-17 by the minimax-marketing x-monitor legal-review pass. The two versions differ materially in (a) the governing-law / forum-selection clauses, (b) the liquidated-damages currency ($15,000 USD vs. €15,000 EUR), and (c) the definition of "we, us, our." Both are reproduced verbatim below.

**Companion documents in this folder:** `x-privacy-policy.md`, `x-developer-agreement.md`, `x-developer-policy.md`, `x-restricted-use-cases.md`, `x-display-requirements.md`, `x-geo-guidelines.md`, `x-developer-policies-index.md`, `x-tos-privacy-update-2026-blog.md`.
...
# PART 1 — Non-EU/EFTA/UK (X Corp.) — Effective: April 10, 2026
...
# PART 2 — EU / EFTA / UK (X Internet Unlimited Company) — Effective: January 15, 2026
