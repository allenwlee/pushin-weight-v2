---
title: "DEPRECATED — v20 iteration-loop companion (consolidated 2026-08-08)"
date: 2026-08-07
deprecated: 2026-08-08
deprecated_reason: "Content consolidated into docs/plans/2026-08-08-001-feat-v22-homepage-production-plan.md § 'Per-iteration procedure (consolidated from 2026-08-07-001, added 2026-08-08)'. Do not edit this file; edit the v22 plan instead. Kept on disk for git-history traceability of iter 1-4."
supersedes_pointer: docs/plans/2026-08-08-001-feat-v22-homepage-production-plan.md
---
...
**Visual source of truth:** `docs/ideation/mockups/06-tier1-composed.v20-{mobile,desktop}-{en,zhcn}.html` *(stale — see v22 plan; canonical is now `06-tier1-composed.v22-master.html`)*
**Viewport:** 390×844 (iPhone 14/15 standard), devicePixelRatio=2, isMobile=true
**Stop condition:** 100 iterations

> **⛔ DEPRECATED 2026-08-08.** This file's content (Scenario matrix A-H, Element Audit procedure, Viewport morphology, Time-based testing, Per-iteration contract, Auth handling, "matches/doesn't match" ranking, Commit policy) has been consolidated into the v22 plan. **Do not edit this file.** Future per-iteration procedure edits happen in the v22 plan § "Per-iteration procedure (consolidated from 2026-08-07-001, added 2026-08-08)". The v22 plan's frontmatter `supersedes:` block points here; this file's frontmatter `supersedes_pointer:` points to the v22 plan.
