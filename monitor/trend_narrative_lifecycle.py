...
def prepare_brand_trend_narrative(
    *,
    ...
    critic_audit_eligible: bool = False,
    narrative_kind: str = "",
    confidence: str = "",
    ...
    with transaction.atomic():
        ...
        return BrandTrendNarrative.objects.create(
            ...
            critic_review_state=critic_review_state,
            critic_reason_codes=critic_reason_codes or [],
            critic_audit_eligible=critic_audit_eligible,
