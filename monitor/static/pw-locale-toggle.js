...
(function () {
  ...
  var CHROME = {
    zh_cn: {
      ...
      pill_brands: '品牌',
      pill_post_type: '帖子类型',
      pill_audience_topics: '受众主题',
      pill_geopolitical: '地缘政治',
      pill_product_labels: '产品',
      pill_role: '角色',
      pill_lang: '语言',
      pill_sentiment: '情绪',
      pill_nationalism: '民族主义',
      pill_untracked_brand_promotions: '未跟踪品牌推广',
      lens_open: '开源',
      lens_closed: '闭源',
      btn_all: '全选',
      btn_clear: '清空',
    ...
    en: {
      ...
      pill_untracked_brand_promotions: 'Untracked Brand Promotions',
      lens_open: 'Open',
      lens_closed: 'Closed',
      btn_all: 'all',
      btn_clear: 'clear',
    ...
    ja: {
      ...
      pill_audience_topics: 'オーディエンストピック',
      pill_geopolitical: '地政学',
      pill_product_labels: '製品',
      pill_role: '役割',
      pill_lang: '言語',
      pill_sentiment: '感情',
      pill_nationalism: 'ナショナリズム',
      pill_untracked_brand_promotions: '未追跡ブランドのプロモーション',
      lens_open: 'オープン',
      lens_closed: 'クローズド',
      btn_all: 'すべて',
      btn_clear: 'クリア',
